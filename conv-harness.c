               ...
               int kernel_order)
{
  ...
  //branch to different switch statement optimisation if too small
  if(nchannels > 3){
          ...
          for ( m = 0; m < nkernels; m++ ) {
            for ( w = 0; w < width; w++ ) {
              for ( h = 0; h < height; h++ ) {
                ...
                sum4 = _mm_setzero_ps();
                for ( c = 0; c < nchannels-3; c+=4 ) {
                  a4=_mm_load_ps(&image[w+0][h+0][c]); b4=_mm_load_ps(&kerns[m][0][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+1][c]); b4=_mm_load_ps(&kerns[m][0][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+2][c]); b4=_mm_load_ps(&kerns[m][0][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+3][c]); b4=_mm_load_ps(&kerns[m][0][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+4][c]); b4=_mm_load_ps(&kerns[m][0][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+0][c]); b4=_mm_load_ps(&kerns[m][1][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+1][c]); b4=_mm_load_ps(&kerns[m][1][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+2][c]); b4=_mm_load_ps(&kerns[m][1][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+3][c]); b4=_mm_load_ps(&kerns[m][1][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+4][c]); b4=_mm_load_ps(&kerns[m][1][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+0][c]); b4=_mm_load_ps(&kerns[m][2][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+1][c]); b4=_mm_load_ps(&kerns[m][2][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+2][c]); b4=_mm_load_ps(&kerns[m][2][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+3][c]); b4=_mm_load_ps(&kerns[m][2][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+4][c]); b4=_mm_load_ps(&kerns[m][2][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+0][c]); b4=_mm_load_ps(&kerns[m][3][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+1][c]); b4=_mm_load_ps(&kerns[m][3][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+2][c]); b4=_mm_load_ps(&kerns[m][3][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+3][c]); b4=_mm_load_ps(&kerns[m][3][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+4][c]); b4=_mm_load_ps(&kerns[m][3][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+0][c]); b4=_mm_load_ps(&kerns[m][4][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+1][c]); b4=_mm_load_ps(&kerns[m][4][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+2][c]); b4=_mm_load_ps(&kerns[m][4][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+3][c]); b4=_mm_load_ps(&kerns[m][4][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+4][c]); b4=_mm_load_ps(&kerns[m][4][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);
                }
                _mm_storeu_ps(&temp[0],sum4);
                sum = temp[0] + temp[1] + temp[2] + temp[3];
                for ( x = 0; x < kernel_order; x++) {
          ...
          for ( m = 0; m < nkernels; m++ ) {
            for ( w = 0; w < width; w++ ) {
              for ( h = 0; h < height; h++ ) {
                ...
                sum4 = _mm_setzero_ps();
                for ( c = 0; c < nchannels-3; c+=4 ) {
                  a4=_mm_load_ps(&image[w+0][h+0][c]); b4=_mm_load_ps(&kerns[m][0][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+1][c]); b4=_mm_load_ps(&kerns[m][0][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+2][c]); b4=_mm_load_ps(&kerns[m][0][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+3][c]); b4=_mm_load_ps(&kerns[m][0][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+4][c]); b4=_mm_load_ps(&kerns[m][0][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+5][c]); b4=_mm_load_ps(&kerns[m][0][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+0][h+6][c]); b4=_mm_load_ps(&kerns[m][0][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+0][c]); b4=_mm_load_ps(&kerns[m][1][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+1][c]); b4=_mm_load_ps(&kerns[m][1][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+2][c]); b4=_mm_load_ps(&kerns[m][1][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+3][c]); b4=_mm_load_ps(&kerns[m][1][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+4][c]); b4=_mm_load_ps(&kerns[m][1][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+5][c]); b4=_mm_load_ps(&kerns[m][1][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+1][h+6][c]); b4=_mm_load_ps(&kerns[m][1][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+0][c]); b4=_mm_load_ps(&kerns[m][2][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+1][c]); b4=_mm_load_ps(&kerns[m][2][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+2][c]); b4=_mm_load_ps(&kerns[m][2][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+3][c]); b4=_mm_load_ps(&kerns[m][2][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+4][c]); b4=_mm_load_ps(&kerns[m][2][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+5][c]); b4=_mm_load_ps(&kerns[m][2][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+2][h+6][c]); b4=_mm_load_ps(&kerns[m][2][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+0][c]); b4=_mm_load_ps(&kerns[m][3][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+1][c]); b4=_mm_load_ps(&kerns[m][3][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+2][c]); b4=_mm_load_ps(&kerns[m][3][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+3][c]); b4=_mm_load_ps(&kerns[m][3][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+4][c]); b4=_mm_load_ps(&kerns[m][3][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+5][c]); b4=_mm_load_ps(&kerns[m][3][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+3][h+6][c]); b4=_mm_load_ps(&kerns[m][3][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+0][c]); b4=_mm_load_ps(&kerns[m][4][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+1][c]); b4=_mm_load_ps(&kerns[m][4][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+2][c]); b4=_mm_load_ps(&kerns[m][4][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+3][c]); b4=_mm_load_ps(&kerns[m][4][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+4][c]); b4=_mm_load_ps(&kerns[m][4][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+5][c]); b4=_mm_load_ps(&kerns[m][4][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+4][h+6][c]); b4=_mm_load_ps(&kerns[m][4][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+0][c]); b4=_mm_load_ps(&kerns[m][5][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+1][c]); b4=_mm_load_ps(&kerns[m][5][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+2][c]); b4=_mm_load_ps(&kerns[m][5][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+3][c]); b4=_mm_load_ps(&kerns[m][5][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+4][c]); b4=_mm_load_ps(&kerns[m][5][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+5][c]); b4=_mm_load_ps(&kerns[m][5][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+5][h+6][c]); b4=_mm_load_ps(&kerns[m][5][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+0][c]); b4=_mm_load_ps(&kerns[m][6][0][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+1][c]); b4=_mm_load_ps(&kerns[m][6][1][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+2][c]); b4=_mm_load_ps(&kerns[m][6][2][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+3][c]); b4=_mm_load_ps(&kerns[m][6][3][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+4][c]); b4=_mm_load_ps(&kerns[m][6][4][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+5][c]); b4=_mm_load_ps(&kerns[m][6][5][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);a4=_mm_load_ps(&image[w+6][h+6][c]); b4=_mm_load_ps(&kerns[m][6][6][c]); c4=_mm_mul_ps(a4,b4); sum4=_mm_add_ps(sum4,c4);
                }
                _mm_storeu_ps(&temp[0],sum4);
                sum = temp[0] + temp[1] + temp[2] + temp[3];
                for ( x = 0; x < kernel_order; x++) {
